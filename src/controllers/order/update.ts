...
import { BadRequestError, IDeliveredWork, IOrderDocument, uploads } from '@irshadkhan2019/job-app-shared';
...
// when buyer cancels the order we need to refund him
// https://dashboard.stripe.com/settings/emails -enable refunds and success mail
const cancel = async (req: Request, res: Response): Promise<void> => {
// https://docs.stripe.com/api/refunds/create
  await stripe.refunds.create({
    payment_intent: `${req.body.paymentIntent}` //can use charge also
